    ...
    <div class="w-full max-w-md relative z-10">
        ...
        <div class="bg-div-15 backdrop-blur-2xl border border-white/5 rounded-xl p-8 md:p-12 shadow-2xl">
            ...
            <div class="flex flex-col items-center mb-10">
                <div class="mb-6">
                    <img :src="store.produto?.logo_maior || 'https://spedppull.b-cdn.net/site/logosp.png'" alt="Logo SPED" class="h-20 w-auto object-contain" />
                </div>
            ...
            <div class="mt-8 text-center space-y-4">
                ...
                <!-- Updated link to /cadastro to match new page name -->
