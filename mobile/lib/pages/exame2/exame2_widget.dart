...
import 'exame2_model.dart';
export 'exame2_model.dart';

class Exame2Widget extends StatefulWidget {
  const Exame2Widget({super.key});

  static String routeName = 'exame2';
  static String routePath = '/exame2';

  @override
  State<Exame2Widget> createState() => _Exame2WidgetState();
}

class _Exame2WidgetState extends State<Exame2Widget> {
  late Exame2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Exame2Model());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      await Future.wait([
        Future(() async {
          _model.voltarparearcicloexame2 = InstantTimer.periodic(
            ...
            callback: (timer) async {
              if (functions.timedif(FFAppState().relogiotela!) ==
                ...
                _model.voltarparearcicloexame2?.cancel();
                ...
                context.goNamed(Parear2Widget.routeName);
              }
            },
        ...
        Future(() async {
          _model.voltarparearc2 = InstantTimer.periodic(
            duration: Duration(milliseconds: 1000),
            callback: (timer) async {
              if (FFAppState().TelaAtual == 'cancelar') {
                _model.voltarparearc2?.cancel();
                await ControlePareamentoTable().update(
                  data: {
                    'pareado_dispositivo': false,
                  },
        ...
        Future(() async {
          _model.atualizartelaexame2 = InstantTimer.periodic(
            duration: Duration(milliseconds: 500),
            callback: (timer) async {
        ...
        Future(() async {
          _model.heartbeat2 = InstantTimer.periodic(
