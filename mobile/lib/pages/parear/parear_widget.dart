...
import 'parear_model.dart';
export 'parear_model.dart';
...
class ParearWidget extends StatefulWidget {
  const ParearWidget({super.key});

  static String routeName = 'parear';
  static String routePath = '/parear';

  @override
  State<ParearWidget> createState() => _ParearWidgetState();
}

class _ParearWidgetState extends State<ParearWidget>
    with TickerProviderStateMixin {
  late ParearModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ParearModel());
          ...
          _model.time_parear2 = InstantTimer.periodic(
            ...
            callback: (timer) async {
              if (FFAppState().TelaAtual == 'parear') {
                ...
                context.goNamed(ExameWidget.routeName);
              }
            },
