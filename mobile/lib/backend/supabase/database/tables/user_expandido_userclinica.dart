...
class UserExpandidoUserclinicaTable
    extends SupabaseTable<UserExpandidoUserclinicaRow> {
  @override
  String get tableName => 'user_expandido_userclinica';

  @override
  UserExpandidoUserclinicaRow createRow(Map<String, dynamic> data) =>
      UserExpandidoUserclinicaRow(data);
}

class UserExpandidoUserclinicaRow extends SupabaseDataRow {
  UserExpandidoUserclinicaRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => UserExpandidoUserclinicaTable();
